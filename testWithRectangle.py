...
pacer = visual.Rect(win=win,size=(2700,200),lineColor="black", pos = ([0,500]))
background = visual.Rect(win=win, size = (3000, 1800), fillColor = 'white', pos = ([0,0]))
...
pic1 = visual.ImageStim(win=win, mask=None,interpolate=True,pos=(0,310), size=(1700,100))
pic2 = visual.ImageStim(win=win, mask=None,interpolate=True,pos=(0,100), size=(1700,100))
pic3 = visual.ImageStim(win=win, mask=None,interpolate=True,pos=(0,-110), size=(1700,100))
pic4 = visual.ImageStim(win=win, mask=None,interpolate=True,pos=(0,-320), size=(1700,100))

pictures = {1:pic1, 2:pic2, 3:pic3, 4:pic4}

p1 = visual.Rect(win=win,size=(1800,120),lineColor="black", pos = ([0,300]))
p2 = visual.Rect(win=win,size=(1800,120),lineColor="black", pos = ([0,100]))
p3 = visual.Rect(win=win,size=(1800,120),lineColor="black", pos = ([0,-100]))
p4 = visual.Rect(win=win,size=(1800,120),lineColor="black", pos = ([0,-300]))
